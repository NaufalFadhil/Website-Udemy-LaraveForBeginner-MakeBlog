...
@section('content')
    ...
    <div class="col-lg-8">
        ...
        <!-- Author -->
        <p class="lead">by <a href="#">{!! $posts->author!!}</a></p>
        <hr>
        <!-- Date/Time -->
        <p>Posted on {!! $posts->created_at !!}</p>
        <hr>
        <!-- Preview Image -->
        {!! Html::image('/img/posts/' . $posts->image, $posts->title, array('style' => 'width: 727px; height: 300px')) !!}
        <hr>
        <!-- Post Content -->
        <p class="lead">{!! $posts->short_desc!!}</p>
